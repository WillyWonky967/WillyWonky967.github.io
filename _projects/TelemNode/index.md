...
In my strategy for desinging the PCB, I used heirarcichal design to my advantage, by creating a child class for the strain gauge amplifiers, which was repurposed throughout the design to amplify the outputs of all the strain gauges in my project. 